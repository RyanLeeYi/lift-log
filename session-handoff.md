...
最後更新：2026-07-31 傍晚（**100/107 passing，v115**；F106／F107／F103 三條做完）
...
| F103 | 停止後可再開始、回 app 視窗一律消失、±15s 同步 | verify_f103 14/14 ＋ 真機 |

線上仍是 **v106**，工作樹 v115 **未部署**——Ryan 2026-07-31 決定「先把目前的問題處理完再上線」。
