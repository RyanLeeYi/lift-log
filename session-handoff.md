...
最後更新：2026-07-31 傍晚（**100/107 passing，v116**；F106／F107／F103 三條做完，F103 ② 的真機回歸已修）
...
線上仍是 **v106**，工作樹 v116 **未部署**——Ryan 2026-07-31 決定「先把目前的問題處理完再上線」。
...
3. **F95 ⑥**：長按通知的手勢，真機
4. verify_f78 ③ 有一條既有 fail（ 與陰影的硬編色，HEAD 就有，非本場造成）
