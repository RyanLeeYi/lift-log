...
const PATHS = {
  ...
  // F86 ⑦：個人紀錄標記（Lucide trophy）。取代先前用的 ★ 字元——
  // 字元會吃系統字型、大小與基線各平台不一，且與 F76 的「結構性圖示不用字元」同一條規則。
  trophy: [
  ...
  // F83：「接著做」的方向指示（Lucide arrow-right）
  "arrow-right": ["M5 12h14", "m12 5 7 7-7 7"],
  // F88 ③：編輯課表的排序（上／下）與刪除（叉）。原本是三個幾何字元——字元會吃系統字型，
  // 各平台粗細與基線都不一樣，且與 F76 訂的「結構性圖示不用字元」同一條規則。
  // （這裡刻意不寫出那三個字元：verify_f88 用純文字搜尋確認它們消失，寫了連註解都算殘留。）
  "arrow-up": ["m5 12 7-7 7 7", "M12 19V5"],
  "arrow-down": ["M12 5v14", "m19 12-7 7-7-7"],
  x: ["M18 6 6 18", "m6 6 12 12"],
  // F81：設定入口（Lucide settings）
  settings: ["M9.671 4.136a2.34 2.34 0 0 1 4.659 0 2.34 2.34 0 0 0 3.319 1.915 2.34 2.34 0 0 1 2.33 4.033 2.34 2.34 0 0 0 0 3.831 2.34 2.34 0 0 1-2.33 4.033 2.34 2.34 0 0 0-3.319 1.915 2.34 2.34 0 0 1-4.659 0 2.34 2.34 0 0 0-3.32-1.915 2.34 2.34 0 0 1-2.33-4.033 2.34 2.34 0 0 0 0-3.831A2.34 2.34 0 0 1 6.35 6.051a2.34 2.34 0 0 0 3.319-1.915", "M12 9a3 3 0 1 0 0 6 3 3 0 0 0 0-6z"],
  // F85：展開／收合指示符（Lucide chevron-down / chevron-right）。原本用幾何字元畫——
  // 那些字不在內嵌字型的字集內，靠系統 fallback 畫，各機大小與基線都不一樣。
  "chevron-down": ["m6 9 6 6 6-6"],
  "chevron-right": ["m9 18 6-6-6-6"],
  // F165：內建對話入口（Lucide message-circle）
