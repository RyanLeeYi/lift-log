...
from verify_f67 import PHONE, REPO, e2e_tmp, free_port, setup_and_home, start_server  # noqa: E402
...
def main() -> int:
    port = free_port()
    db = e2e_tmp() / f"liftlog_f79_{port}.db"
    release = e2e_tmp() / f"liftlog_f79_release_{port}"
