...
def main():
    ...
    try:
        ...
        with sync_playwright() as pw:
            ...
            check("⑧ APP_VERSION 與 sw.js CACHE_NAME 同步遞增（兩處一致，≥v55）",
                  ver.startswith("v") and int(ver[1:]) >= 55
            ...
            # 不納入遞減比較——但各高度都必須不破圖
            check("⑤ 667 高也能填滿（填滿模式內高度隨螢幕遞減），且門檻上下皆不破圖（不溢出、不疊住按鈕）",
